...
fig.tight_layout()
fig.savefig(f"{OUT}/fig1_redock_benchmark.png", bbox_inches="tight")
fig.savefig(f"{OUT}/fig1_redock_benchmark.pdf", bbox_inches="tight")
plt.close(fig)
...
fig.tight_layout()
fig.savefig(f"{OUT}/fig2_donor_metal_distance.png", bbox_inches="tight")
fig.savefig(f"{OUT}/fig2_donor_metal_distance.pdf", bbox_inches="tight")
plt.close(fig)
