...
struct output_type {
	...
	fl metal_rerank;
	fl metal_geo_rerank;
	fl metal_water_rerank;
	fl metal_jt_rerank;
	fl ligand_metal_geom_penalty;
	fl ligand_metal_geom_rerank;
	vecv coords;
	output_type(const conf& c_, fl e_) : c(c_), e(e_), metal_rerank(0), metal_geo_rerank(0), metal_water_rerank(0), metal_jt_rerank(0), ligand_metal_geom_penalty(0), ligand_metal_geom_rerank(0) {}
